...
public class BeerOfGreed extends CustomItem {
    @Override
    public String getName() {
        return LangConfig.get().getString("name.beer-greed");
    }
    ...
    public List<String> getLore() {
        return Arrays.asList(Common.colorize(LangConfig.get().getString("description.beer-greed")));
    }
