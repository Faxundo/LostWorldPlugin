...
public class AxeOfWar extends CustomItem {
    @Override
    public String getName() {
        return LangConfig.get().getString("name.axe-war");
    }
    ...
    public List<String> getLore() {
        return Arrays.asList(Common.colorize(LangConfig.get().getString("description.axe-war")));
    }
